...
export default function RootLayout({
  ...
  return (
    <html lang="zh-CN" suppressHydrationWarning>
      ...
      <body className="bg-gradient-to-br from-pink-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 min-h-screen transition-colors duration-200 relative antialiased">
        ...
        <ThemeProvider>
        {/* Header */}
        <header className="relative z-10 bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border-b border-pink-100/50 dark:border-gray-700/50 sticky top-0">
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-extrabold tracking-tight bg-gradient-to-r from-pink-600 to-purple-600 dark:from-pink-400 dark:to-purple-400 bg-clip-text text-transparent">
                  AI 医学美容分析
                </h1>
        ...
        {/* Main */}
        <main className="relative z-10 max-w-6xl mx-auto px-4 py-6 md:py-10">{children}</main>

        {/* Footer */}
        <footer className="relative z-10 text-center py-6 text-[11px] text-gray-400 dark:text-gray-500 tracking-wide">
